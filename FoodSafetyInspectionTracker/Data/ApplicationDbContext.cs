...
public class ApplicationDbContext : IdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Premises>().HasData(SeedData.GetPremises());
        builder.Entity<Inspection>().HasData(SeedData.GetInspections());
        builder.Entity<FollowUp>().HasData(SeedData.GetFollowUps());
    }
}